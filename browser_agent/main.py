    ...
    async def start(self):
        ...
        try:
            async with async_playwright() as p:
                ...
                await self.page.screenshot(path="game_screenshot/game_screenshot.png")
                print('Screenshot saved as game_screenshot/game_screenshot.png')
                ...
                if nested_iframe_element:
                    ...
                    if canvas:
                        ...
                        for move_num in range(5):
                            ...
                            await self.page.screenshot(path=f"game_screenshot/game_screenshot_drag_{move_num+1}.png")
                            print(f'Screenshot after move {move_num+1} saved as game_screenshot/game_screenshot_drag_{move_num+1}.png')
                            img_bytes = await canvas.screenshot()
                            img = Image.open(io.BytesIO(img_bytes))
                            img.save(f"game_screenshot/game_screenshot_canvas_{move_num+1}.png")
                            print(f'Canvas image for move {move_num+1} saved as game_screenshot/game_screenshot_canvas_{move_num+1}.png')
                ...
                # await asyncio.sleep(99999)  # Uncomment to keep browser open
        except TargetClosedError:
            print("Browser or page was closed by the user. Exiting gracefully.")
